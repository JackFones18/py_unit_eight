...
# this code sets up the buttons that allows the user to designate how many diners are splitting the tip
...
perperson_label = tk.Label(root, text="Amount Per Person")
perperson_label.grid(row=6, column=1)

perperson_display = tk.Label(root, textvariable=total)
perperson_display.grid(row=6, column=2)
...
calculate.grid(row=8, column=1, columnspan=2)
